...
module.exports = function(settings) {
     ...
     */
    tasks.googleStore = function publishGoogle(done) {
     ...
     * @param {Function} done Gulp task callback.
     */
    tasks.mozillaStore = async function publishMozilla(done) {
    ...
    */
    ...
    tasks.sentryRemove = function publishSentryRemoveRelease(done) {
        const sentryManager = helpers.sentryManager()
